...
export const ACTIVITIES: IActivity[] = [
  {
    ...
    "athlete": "Azeez",
    "date": new Date("2023-04-09T10:45:00Z"),
    "starting": {
...

  {
    ...
    "athlete": "Muili",
    "date": new Date("2023-03-28T09:24:15"),
    "starting": {
      "coords": [2.351849406202035, 4.52797827174534],
      "name": "Lausanne",
      "timeStamp": new Date("2023-03-28T09:24:15"),
    },
    "stopping": {
...

  {
    ...
    "athlete": "Idan",
    "date": new Date("2023-03-31T09:24:15"),
    "starting": {
...

  {
    ...
    "athlete": "Ilium",
    "date": new Date("2023-04-01T10:45:00Z"),
    "starting": {
      "coords": [2.351849406202035, 5.52797827174534],
      "name": "Xamax",
      "timeStamp": new Date("2023-04-07T10:45:00Z"),
